...
const steps = [
  {
    icon: Search,
    title: "Search & Browse",
    description: "Find the service you need from our wide range of categories and browse verified providers in your area.",
    step: "01"
  },
  {
    icon: UserCheck,
    title: "Choose Provider",
    description: "Compare profiles, ratings, and pricing. Read reviews from previous customers to make your choice.",
    step: "02"
  },
  {
    icon: Calendar,
    title: "Book Service",
    description: "Schedule at your convenience. Choose regular appointments or urgent booking for immediate needs.",
    step: "03"
  },
  {
    icon: Star,
    title: "Get Service & Rate",
    description: "Enjoy professional service and rate your experience to help others find the best providers.",
    step: "04"
  }
];
...
const HowItWorks = () => {
  return (
    <section id="how-it-works" className="py-20 bg-gradient-to-br from-accent/10 to-primary/5">
